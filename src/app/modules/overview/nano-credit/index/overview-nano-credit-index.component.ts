...
@Component({
    selector: 'app-overview-nano-credit-index-component',
    templateUrl: './overview-nano-credit-index.component.html',
    styleUrls: ['./overview-nano-credit-index.component.css']
})
export class OverviewNanoCreditIndexComponent implements OnInit {
